            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <input 
                        ...
                        name="nisn" 
                        value="{{ old('nisn') }}"
                        class="w-full rounded-xl bg-slate-50 dark:bg-slate-900 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white focus:ring-blue-500 focus:border-blue-500 transition py-2.5 px-4" 
                ...
                <div class="col-span-1">
                    ...
                    <div class="relative">
                        <select 
                            name="jenis_kelamin" 
                            class="w-full rounded-xl bg-slate-50 dark:bg-slate-900 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white focus:ring-blue-500 focus:border-blue-500 transition py-2.5 px-4 appearance-none" 
                            required
                        >
                ...
                <!-- Spasi biar grid rapi (kosongkan kolom kanan) -->
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        <select 
                            name="prodi_pilihan" 
                            class="w-full rounded-xl bg-slate-50 dark:bg-slate-900 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white focus:ring-blue-500 focus:border-blue-500 transition py-3 px-4 appearance-none" 
                            required
                        >
                            <option value="" disabled {{ old('prodi_pilihan') ? '' : 'selected' }}>-- Pilih Jurusan Impianmu --</option>
                            <option value="Teknik Informatika" {{ old('prodi_pilihan') == 'Teknik Informatika' ? 'selected' : '' }}>Teknik Informatika (S1)</option>
                            <option value="Sistem Informasi" {{ old('prodi_pilihan') == 'Sistem Informasi' ? 'selected' : '' }}>Sistem Informasi (S1)</option>
                            <option value="Teknologi Informasi" {{ old('prodi_pilihan') == 'Teknologi Informasi' ? 'selected' : '' }}>Teknologi Informasi (S1)</option>
                            <option value="Bisnis Digital" {{ old('prodi_pilihan') == 'Bisnis Digital' ? 'selected' : '' }}>Bisnis Digital (S1)</option>
                            <option value="Akuntansi" {{ old('prodi_pilihan') == 'Akuntansi' ? 'selected' : '' }}>Akuntansi (S1)</option>
                        </select>
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-slate-500">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea 
                        name="alamat" 
                        rows="3" 
                        class="w-full rounded-xl bg-slate-50 dark:bg-slate-900 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white focus:ring-blue-500 focus:border-blue-500 transition py-3 px-4" 
